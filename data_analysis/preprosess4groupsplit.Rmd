...
## Set paths
filepath <- "D:/Filez/李征/Sync/同步文件夹/博士研究课题/OHBM会议数据分析/behavior_data/behavior/"
outpath <- "D:/Filez/李征/Sync/同步文件夹/博士研究课题/OHBM会议数据分析/behavior_data/output/"
...
diagnosis_select_column <- c("Identifiers", "DX_01_Cat")
...
MSN_names <- c(names(MSN_vovars)[2:361], "Identifiers", "study_site", "age", "sex", "euler")
...
## 识别MSN缺失值的情况
```{r}
target_cols <- c("Identifiers", names(MSN_vovars)[2:361], "study_site", "age", "sex", "euler")
MSN_new <- merged_data %>%
