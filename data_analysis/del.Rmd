...
```{r}
split_file_path <- '/Users/lizheng/Desktop/同步文件夹/博士研究课题/OHBM会议数据分析/behavior_data/output/'
MSN_path <- '/Users/lizheng/Desktop/同步文件夹/博士研究课题/OHBM会议数据分析/HBN/Freesurfer/'
output_path <- '/Users/lizheng/Desktop/同步文件夹/博士研究课题/OHBM会议数据分析/freesurfer_split/'
```
...
ci <- fread(paste0(MSN_path, "hbn_df_ci_pass_harmonized.tsv"))
ct <- fread(paste0(MSN_path, "hbn_df_ct_pass_harmonized.tsv"))
fi <- fread(paste0(MSN_path, "hbn_df_fi_pass_harmonized.tsv"))
gc <- fread(paste0(MSN_path, "hbn_df_gc_pass_harmonized.tsv"))
gv <- fread(paste0(MSN_path, "hbn_df_gv_pass_harmonized.tsv"))
mc <- fread(paste0(MSN_path, "hbn_df_mc_pass_harmonized.tsv"))
sa <- fread(paste0(MSN_path, "hbn_df_sa_pass_harmonized.tsv"))
```
