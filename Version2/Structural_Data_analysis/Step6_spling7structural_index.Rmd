...
```{r}
split_file_path <- '/Users/lizheng/Desktop/同步文件夹/博士研究课题/OHBM会议数据分析/Version2/output/'
MSN_path <- '/Users/lizheng/Desktop/同步文件夹/博士研究课题/OHBM会议数据分析/Version2/Structural_data/'
output_path <- '/Users/lizheng/Desktop/同步文件夹/博士研究课题/OHBM会议数据分析/Version2/Structural_data/Structural_split/'
```
...
ci <- fread(paste0(MSN_path, "hbn_df_ci_pass.tsv"))[, c(103, 2:101)]
ct <- fread(paste0(MSN_path, "hbn_df_ct_pass.tsv"))[, c(103, 2:101)]
fi <- fread(paste0(MSN_path, "hbn_df_fi_pass.tsv"))[, c(103, 2:101)]
gc <- fread(paste0(MSN_path, "hbn_df_gc_pass.tsv"))[, c(103, 2:101)]
gv <- fread(paste0(MSN_path, "hbn_df_gv_pass.tsv"))[, c(103, 2:101)]
mc <- fread(paste0(MSN_path, "hbn_df_mc_pass.tsv"))[, c(103, 2:101)]
sa <- fread(paste0(MSN_path, "hbn_df_sa_pass.tsv"))[, c(103, 2:101)]
```
