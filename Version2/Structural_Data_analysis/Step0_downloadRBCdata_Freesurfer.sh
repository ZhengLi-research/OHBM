# 定义数据存储路径
cd /Users/lizheng/Desktop/RBC/HBN/HBN_FreeSurfer/freesurfer

DATA_PATH="/Users/lizheng/Desktop/RBC/HBN/HBN_FreeSurfer/freesurfer"  # 替换为你的实际路径
OUTPUT_PATH="/Users/lizheng/Desktop/missing"          # 替换为输出文件的路径
